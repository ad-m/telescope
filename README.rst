...
telescope relies extensively on environment settings which **will not work with Apache/mod_wsgi setups**. It has been deployed successfully with both Gunicorn/Nginx and even uWSGI/Nginx.

For configuration purposes, the following table maps the 'telescope' environment variables to their Django setting:
...
..  code-block:: bash
    ...
    git remote add dokku dokku@yourservername.com:telescope
    git push dokku master
    ssh -t dokku@yourservername.com dokku memcached:create telescope-memcached
    ssh -t dokku@yourservername.com dokku memcached:link telescope-memcached telescope
    ssh -t dokku@yourservername.com dokku postgres:create telescope-postgres
    ...
    ssh -t dokku@yourservername.com dokku run telescope python manage.py createsuperuser
